...
var $author$project$App$reload_log = $elm$http$Http$get(
	{
		expect: $elm$http$Http$expectString($author$project$App$SetLog),
		url: 'log'
	});
var $author$project$App$init = function (flags) {
	return _Utils_Tuple2(
		$author$project$App$load_flags(flags),
		$author$project$App$reload_log);
};
...
var $author$project$App$FileSaved = F2(
	function (a, b) {
...
var $author$project$App$delayMsg = F2(
	function (delay, msg) {
		return A2(
			$elm$core$Task$perform,
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$name('csrfmiddlewaretoken'),
								$elm$html$Html$Attributes$value(model.csrf_token)
							]),
						_List_Nil)
					])));
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('editor-controls')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('file-path'),
								$elm$html$Html$Attributes$class('file-path')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(model.file_path)
							])),
						A2(
						$elm$html$Html$span,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('file-changed-status'),
								$elm$html$Html$Attributes$classList(
								_List_fromArray(
									[
										_Utils_Tuple2('changed', model.content_changed)
									]))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
								model.content_changed ? 'changed' : 'saved')
							])),
						A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$action('delete-file')
									]),
								_List_fromArray(
									[
										A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$method('POST'),
										$elm$html$Html$Attributes$action('rename-file')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												...
												$elm$html$Html$Attributes$name('newpath'),
												$elm$html$Html$Attributes$value(model.file_path)
											]),
										_List_Nil),
										A2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(model.slug)
					])),
				A2(
				$elm$html$Html$p,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('think-controls')
					]),
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('size-values')
							]),
						_List_fromArray(
							[
								A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('file-tree')
							]),
						A2(
							$elm$core$List$map,
							function (f) {
								return A2(
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													_Utils_Tuple2('dir', f.is_dir),
													_Utils_Tuple2('file', !f.is_dir),
													_Utils_Tuple2('file-path', true)
												]))
										]),
									_List_fromArray(
										[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$id('new-file-button'),
										$elm$html$Html$Attributes$type_('submit')
									]),
								_List_fromArray(
									[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$id('run-command-button'),
										$elm$html$Html$Attributes$type_('submit')
									]),
								_List_fromArray(
									[
...
var $author$project$App$TogglePreview = function (a) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2(
					$elm$json$Json$Decode$map,
					$author$project$App$TogglePreview,
					A2(
						$elm$json$Json$Decode$at,
						_List_fromArray(
							['target', 'open']),
...
var $author$project$App$view = function (model) {
	return {
		body: _List_fromArray(
			[
				$author$project$App$header(model),
				A2(
				$elm$html$Html$main_,
				_List_fromArray(
					[
